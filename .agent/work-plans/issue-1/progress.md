...
- [ ] (suggestion) Comment says projection is "affine in pixel-x"; in slant mode it's nonlinear but monotonic in |d| (result still correct) — reword to "monotonic" — `src/waterfall_widget.cpp:857`
